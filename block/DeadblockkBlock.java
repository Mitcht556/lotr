...
import net.mcreator.dragonball.procedures.DeadblockkOnBlockRightClickedProcedure;
...
public class DeadblockkBlock
extends Block {
    public DeadblockkBlock() {
        super(BlockBehaviour.Properties.m_284310_().m_60918_(SoundType.f_56744_).m_60913_(1.0f, 10.0f));
    }
    ...
    public InteractionResult m_6227_(BlockState blockstate, Level world, BlockPos pos, Player entity, InteractionHand hand, BlockHitResult hit) {
        ...
        DeadblockkOnBlockRightClickedProcedure.execute((LevelAccessor)world, x, y, z, (Entity)entity);
